...
return [
    ...
    */
    ...
    'seo'                 => [
        'author'          => 'Check-in DOG',
        'description'     => 'Check-in DOG is the comprehensive management solution for your grooming shop: customers and pets details management, appointments and automatic reminders, billing and innovative marketing tools. Designed to save you time and money.',
        'keywords'        => 'checkindog, pet grooming, software',
        'og'              => [
            'title'       => 'Check-in DOG pet grooming software',
            'type'        => 'article',
            'url'         => '',
            'image'       => '',
            'description' => '',
